...
if (isset($_POST['editSubmit'])) {
  ...
  $sql = "UPDATE accounts SET name='$editName',type='$edittype',balance='$editAmt' WHERE id='$editId' and uid='$user_id'";
...
if (isset($_POST['editDelete'])) {
  ...
  // Update the row in the database
  $sql = "DELETE FROM accounts WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
<body>
  ...
  <div class="pagetitle">
    ...
    <section class="section">
     ...
     $c=$c+1;
              ...
              <button class="btn btn-primary" type="button" id="" onclick="window.location.href = 'newaccounts.php';" >Add New Expense</button>
    </div>
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="">
      ...
      <option value="savings" class="form-label">Savings</option>
      <option value="credit card" class="form-label">Credit Card</option>
      <option value="loan account" class="form-label">Loan Account</option>
      <option value="mortage account" class="form-label">Mortage Account</option>
      <option value="investment" class="form-label">Investments</option>
      
    </select>
      <label for="editName">New Balance:</label>
      <br>
