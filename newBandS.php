            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create a Bill/Subscription</h5>
...
$query = "SELECT * FROM categories WHERE user_id='$user_id' and type='Bills/Subscriptions'";
...
?>
                    ...
                    <div class="col-12">
                      ...
                      <label for="yourName" class="form-label">Plan(Mention the plan in days)</label>
                      <input type="number" name="days" class="form-control" id="amount" required>
                      <div class="invalid-feedback">Required</div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0"><a href="BandS.php">Go Back</a></p>
                    </div>
                  </form>
  ...
  $conn = mysqli_connect('localhost', 'root', '', 'expense');
                 ...
                 $sql = "INSERT INTO bands(category,amount,account_type,days,uid) VALUES ('$cat','$amt','$cat1','$days','$user_id')";
                 $sql1 = "UPDATE accounts SET balance = balance - $amt WHERE uid = '$user_id' AND name='$cat1'";
