...
if (isset($_POST['editSubmit'])) {
  ...
  $sql = "UPDATE categories SET category='$editName' WHERE id='$editId' and user_id='$user_id'";
...
if (isset($_POST['editDelete'])) {
  ...
  // Update the row in the database
  $sql = "DELETE FROM categories WHERE id='$editId' and user_id='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
$sql = "SELECT * FROM categories WHERE user_id='$user_id' and type='expense'";
$result1 = mysqli_query($conn, $sql);
$sql1 = "SELECT * FROM categories WHERE user_id='$user_id' and type='income'";
$result2 = mysqli_query($conn, $sql1);
$sql2 = "SELECT * FROM categories WHERE user_id='$user_id' and type='Bills/Subscriptions'";
$result3 = mysqli_query($conn, $sql2);
$sql3 = "SELECT * FROM categories WHERE user_id='$user_id' and type='assets'";
$result4 = mysqli_query($conn, $sql3);
$sql4= "SELECT * FROM categories WHERE user_id='$user_id' and type='investments'";
...
<body>
  ...
  <div class="pagetitle">
    ...
    <section class="section">
     ...
     $c=$c+1;
              ...
              <button class="btn btn-primary" type="button" id="" onclick="window.location.href = 'newcategory.php';" >Add New Category</button>
    </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Bills and Subscription</h5>
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="">
      ...
      <label for="editName">New Category:</label>
      <br>
