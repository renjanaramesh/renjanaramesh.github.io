...
if (isset($_POST['editSubmit'])) {
  ...
  $sql = "UPDATE bands SET category='$editName',amount='$editamt' WHERE id='$editId' and uid='$user_id'";
...
if (isset($_POST['editDelete'])) {
  ...
  // Update the row in the database
  $sql = "DELETE FROM bands WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
$sql = "SELECT * FROM bands WHERE uid='$user_id'";
...
<body>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Your bills and subscriptions</h5>
      ...
      while ($row = mysqli_fetch_assoc($result1)){
        ...
        $query = "SELECT * FROM accounts WHERE name = '$acctype'";
     ...
     $c=$c+1;
              ...
              <button class="btn btn-primary" type="button" id="" onclick="window.location.href = 'newBandS.php';" >Add New </button>
    </div>
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="">
      ...
      <label for="editName">New Bills/Subscriptions:</label>
      <br>
