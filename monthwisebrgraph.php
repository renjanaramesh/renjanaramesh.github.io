...
$date1=$_POST["date1"];
$date2=$_POST["date2"];
      $sql = "SELECT * FROM budget WHERE datec BETWEEN '$date1' AND '$date2' AND uid='$user_id'";
...
if($stmt = $connection->query("SELECT category,amount FROM budget WHERE datec BETWEEN '$date1' AND '$date2' AND uid='$user_id'")){
