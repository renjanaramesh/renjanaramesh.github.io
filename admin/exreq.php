...
if (isset($_POST["editSubmit"])) {
  ...
  $update = "UPDATE expert SET status='Active' WHERE id='$editId' ";
 ...
 if (isset($_POST["editSubmit1"])) {
  ...
  // Update the row in the database
  $update = "UPDATE expert SET status='Disapproved' WHERE id='$editId' ";
...
$sql = "SELECT * FROM expert WHERE status='Inactive'";
...
<body>
      ...
      while ($row = mysqli_fetch_assoc($result1)){
       ?>
        <tr>
         ...
         <td>
          <?php
            $fileExtension = pathinfo($row['certifications'], PATHINFO_EXTENSION);
            if ($fileExtension === 'jpg' || $fileExtension === 'png') {
              echo '<a href="' . $row['certifications'] . '" download>Download</a>';
            } elseif ($fileExtension === 'pdf') {
              echo '<a href="' . $row['certifications'] . '" target="_blank">View PDF</a>';
            } else {
              echo '<a href="' . $row['certifications'] . '" download>Download</a>';
            }
          ?>
        ...
        <td>
          <?php
            $fileExtension = pathinfo($row['resume'], PATHINFO_EXTENSION);
            if ($fileExtension === 'jpg' || $fileExtension === 'png') {
              echo '<a href="' . $row['resume'] . '" download>Download</a>';
            } elseif ($fileExtension === 'pdf') {
              echo '<a href="' . $row['resume'] . '" target="_blank">View PDF</a>';
            } else {
              echo '<a href="' . $row['resume'] . '" download>Download</a>';
            }
          ?>
          ...
          <td>
            <button class="btn btn-primary" onclick="showEditForm(<?php echo  $row['id'];; ?>)">Take Action</button>
          </td>
        </tr>
      <?php 
     $c=$c+1;
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      ...
      <h5>What action you want to take?</h5>
      
      
     
<br>
      <button class="btn btn-primary" type="submit" name="editSubmit">Approve</button>
      <br>
      <br>
      <button class="btn btn-primary" type="submit" name="editSubmit1">Disapprove</button>
      <br>
      <br>
