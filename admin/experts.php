...
if (isset($_POST["editSubmit"])) {
  ...
  $update = "DELETE FROM expert WHERE id='$editId' ";
      ...
      while ($row = mysqli_fetch_assoc($result1)){
       ?>
        ...
        <td>
          ...
          <td>
            <button class="btn btn-primary" onclick="showEditForm(<?php echo  $row['id'];; ?>)">Delete</button>
          </td>
        </tr>
      <?php 
     $c=$c+1;
...
<br>
      <button class="btn btn-primary" type="submit" name="editSubmit">Confirm</button>
      <br>
      <br>
