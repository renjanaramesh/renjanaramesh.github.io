  ...
  <main id="main" class="main">
    ...
    <form method="POST">
      <div class="col-12">
                    ...
                    <input type="number" name="date1" class="form control" placeholder="YYYY" min="2000" max="2100" style="width: 100%;" required>
<script>
...
$date1=$_POST['date1'];
      ...
      $sql = "SELECT * FROM expenses WHERE year='$date1' and uid='$user_id'";
$result1 = mysqli_query($conn, $sql);
$sql2 = "SELECT * FROM bands WHERE year='$date1' and uid='$user_id'";
$result2 = mysqli_query($conn, $sql2);
?>
<table class="table datatable">
  <h5> You are viewing report on <?php echo $date1?></h5>
                <thead>
                  <tr>
                    <th scope="col">#</th>
     ...
     $d=$d+1;
              ...
              <?php
              $queryExpenses = "SELECT category, amount FROM expenses WHERE year='$date1' and uid='$user_id'";
              ...
              $queryBands = "SELECT category, amount FROM bands WHERE year='$date1' and uid='$user_id'";
