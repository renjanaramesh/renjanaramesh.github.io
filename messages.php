...
if (isset($_POST['editSubmit'])) {
  ...
  $sql = "UPDATE expenses SET category='$editName',amount='$editamt' WHERE id='$editId' and uid='$user_id'";
...
if (isset($_POST['editDelete'])) {
  ...
  // Update the row in the database
  $sql = "DELETE FROM expenses WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
$sql = "SELECT * FROM conversation WHERE uid='$user_id' and visibility='Unseen'";
$result1 = mysqli_query($conn, $sql);
$sql1 = "SELECT * FROM appointment WHERE uid='$user_id' and visibility='Unseen'";
$result2 = mysqli_query($conn, $sql1);
$stmt="SELECT * FROM conversation WHERE uid='$user_id'";
$r1 = mysqli_query($conn, $stmt);
$stmt1="SELECT * FROM appointment WHERE uid='$user_id'";
$r2 = mysqli_query($conn, $stmt1);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="pagetitle">
    ...
    <h5 class="card-title">Previous Messages</h5>
    <section class="section">
      ...
      while ($row = mysqli_fetch_assoc($r1)){
        ...
        <tr>
          ...
          <td><?php echo $acctype1 ?></td>
          <td><?php echo $acctype2 ?></td>
        </tr>
      <?php 
     $c=$c+1;
      } ?>
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="">
      ...
      <label for="editName">New Expense:</label>
      <br>
