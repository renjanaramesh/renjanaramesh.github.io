...
$date1=$_POST['date1'];
      ...
      $sql = "SELECT * FROM budget WHERE year='$date1' and uid='$user_id'";
...
require "config.php";
$query = "SELECT category,amount FROM budget WHERE year='$date1' and uid='$user_id'";
$result = mysqli_query($connection, $query);

// Initialize arrays to store x-axis and y-axis values
$xAxis = array();
$yAxis = array();

// Fetching data and populating the arrays
...
<script>
    var xValues = <?php echo json_encode($xAxis); ?>;
    var yValues = <?php echo json_encode($yAxis); ?>;
