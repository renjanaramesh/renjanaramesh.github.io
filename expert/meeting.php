...
if (isset($_POST["editSubmit"])) {
  ...
  $update = "UPDATE appointment SET msg='$editName',amount='$editAmt',status='Closed' WHERE id='$editId' ";
...
$sql = "SELECT * FROM appointment WHERE  exid='$user_id' and status='Active'";
...
<body>
    ...
    <section class="section">
      ...
      while ($row = mysqli_fetch_assoc($result1)){
        ...
        <tr>
          ...
          <td><?php echo $msg; ?></td>
          <td>
            <button class="btn btn-primary" onclick="showEditForm(<?php echo $id; ?>)">Reply</button>
          </td>
        </tr>
      <?php 
     $c=$c+1;
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      ...
      <label for="editName">Enter Your Message</label>
      <br>
      <input type="text" class="form-control" name="editName" id="editName">
      <label for="editName">Enter Amount</label>
      <br>
