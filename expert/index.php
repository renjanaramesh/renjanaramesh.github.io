          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Your Message Requests </h5>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <h6><?php 
$sql1 = "SELECT COUNT(id) AS count_msg FROM conversation WHERE exid = '$user_id' and status='Active' ";
    ...
    $amt= $row1["count_msg"];
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Your Appointment Requests</h5>

                  <div class="d-flex align-items-center">
                    
                    <div class="ps-3">
                      <h6><?php 
$sql2 = "SELECT COUNT(id) AS count_app FROM appointment WHERE exid = '$user_id' and status='Active'";
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php
            $dueDateQuery = "SELECT * FROM conversation WHERE exid = '$user_id' and status='Active'";
        ...
        if ($result1) {
            ...
            $name = $row['name'];
                    ...
                    $notificationMessage = "Your have one message from $name \n";
        ...
        echo "<h5>".$notificationMessage."</h5>"; 
            ...
            $dueDate = "SELECT * FROM appointment WHERE exid = '$user_id' and status='Active'";

            // Execute the query
            $result2 = $conn->query($dueDate);
        ...
        if ($result3) {
            ...
            $name = $row['name'];
                    ...
                    // Generate the notification message
                    $notificationMessage = "Your have one appointment from $name \n";
