            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Send a Message</h5>
                   
                  </div>
                  <form class="row g-3 needs-validation" method="POST"  action="">
                    <div class="col-12">
                      <label for="yourName" class="form-label">Select a User</label>
...
?>
                    ...
                    <div class="col-12">
                      ...
                      <label for="yourName" class="form-label">Enter Your Message</label>
                      <textarea name="msg" class="form-control" id="yourName" required></textarea>
...
?>
                    ...
                    <div class="col-12">
                      <p class="small mb-0"><a href="expense.php">Go Back</a></p>
                    </div>
                  </form>
  ...
  $conn = mysqli_connect('localhost', 'root', '', 'expense');
                 ...
                 $sql = "INSERT INTO expenses(category,amount,account_type,uid) VALUES ('$cat','$amt','$cat1','$user_id')";
