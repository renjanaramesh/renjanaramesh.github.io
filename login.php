...
<head>
  ...
  <title>Pages / Login - FinApp Bootstrap Template</title>
  ...
  <script>
    function validateLogin() {
      ...
      // Replace 'your-php-file.php' with the actual PHP file that handles the validation
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="credits">
                ...
                Are you an Expert? <a href="expert/login.php">Login</a>
                <br>
                Or an Admin? <a href="admin/login.php">Login</a>
              </div>
