  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="col-12">
                  ...
                  <br>
                  <button class="btn btn-primary " type="submit" name="b" onclick="window.location.href = 'monthwiseergraph.php'">Create Monthwise Report</button>
                  <br>
                <br>
                <button class="btn btn-primary " type="submit" name="b" onclick="window.location.href = 'linegraphER.php'">Create YearWise Report</button>
    <br>
      </form>
      <?php
...
$date1=$_POST["date1"];
      ...
      $sql = "SELECT * FROM expenses WHERE datec='$date1' and uid='$user_id'";
$result1 = mysqli_query($conn, $sql);
$sql2 = "SELECT * FROM bands WHERE datec='$date1' and uid='$user_id'";
...
<table class="table datatable">
     ...
     $d=$d+1;
              ...
              <?php
              $queryExpenses = "SELECT category, amount FROM expenses WHERE datec='$date1' and uid='$user_id'";
              ...
              $queryBands = "SELECT category, amount FROM bands WHERE datec='$date1' and uid='$user_id'";
