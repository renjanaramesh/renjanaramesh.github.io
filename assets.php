...
if (isset($_POST['editSubmit'])) {
  ...
  $sql = "UPDATE assets SET name='$editName',type='$type',value='$editAmt' WHERE id='$editId' and uid='$user_id'";
...
if (isset($_POST['editclose'])) {
  ...
  // Update the row in the database
  $sql = "UPDATE assets SET status='Closed' WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
if (isset($_POST['editDelete'])) {
  ...
  // Update the row in the database
  $sql = "DELETE FROM assets WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
$sql = "SELECT * FROM assets WHERE uid='$user_id'";
  ...
  <div class="pagetitle">
    ...
    <section class="section">
     ...
     $c=$c+1;
              ...
              <button class="btn btn-primary" type="button" id="" onclick="window.location.href = 'newassets.php';" >Add New Asset</button>
    </div>
...
$query = "SELECT * FROM categories WHERE user_id='$user_id' and type='assets'";
...
?>
      ...
      <br>
      <input type="text" class="form-control" name="editAmt" id="editAmt">
