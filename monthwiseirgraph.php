...
;
$sql3 = "SELECT * FROM income  WHERE datec BETWEEN '$date1' AND '$date2' AND uid='$user_id'";
...
?>
     ...
     $d=$d+1;
              ...
              $queryincome = "SELECT category,amount FROM income  WHERE datec BETWEEN '$date1' AND '$date2' AND uid='$user_id'";
