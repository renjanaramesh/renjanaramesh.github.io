...
<head>
  ...
  <title>Expenses / Alerts - FinApp Bootstrap Template</title>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <table id="budgetTable" class="table" style="width:300px">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Budget</th>
                        ...
                        <form id="addBudgetForm">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="category" name="category" required>
                                    <!-- Dropdown options will be dynamically populated using AJAX -->
                                </select>
                            </div>
                            <div class="form-group">
        ...
        <!-- Add New Budget Icon -->
        <button class="btn btn-primary" id="openModalButton">Add New Budget</button>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addBudgetForm').submit(function(event) {
                ...
                $.ajax({
                    url: 'add_budget.php', // Replace with your PHP script for adding a budget
                    method: 'POST',
                    data: formData,
            ...
            // Open modal when clicking the "Add New Budget" button
