  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="col-12">
                  ...
                  <br>
                  <button class="btn btn-primary " type="submit" name="b" onclick="window.location.href = 'monthwiseirgraph.php'">Create Monthwise Report</button>
                  <br>
                <br>
                <button class="btn btn-primary " type="submit" name="b" onclick="window.location.href = 'linegraphIR.php'">Create YearWise Report</button>
    <br>
      </form>
      <?php
...
$sql = "SELECT * FROM income WHERE datec='$date1' and uid='$user_id'";
...
<table class="table datatable">
     ...
     $c=$c+1;
              ...
              $queryincome = "SELECT category,amount FROM income WHERE datec='$date1' and uid='$user_id'";
              ...
              if (mysqli_num_rows($resultincome) > 0) {
                  while ($rowBands = mysqli_fetch_assoc($resultincome)) {
