...
if (isset($_POST['editSubmit'])) {
  ...
  $sql = "UPDATE investments SET company_name='$editName',investment_type='$type',amount='$editAmt',account='$account',number='$num',current_price='$price',price_date='$date' WHERE id='$editId' and uid='$user_id'";
...
if (isset($_POST['editclose'])) {
  ...
  // Update the row in the database
  $sql = "UPDATE investments SET status='Closed' WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
if (isset($_POST['editDelete'])) {
  ...
  // Update the row in the database
  $sql = "DELETE FROM investments WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
$sql = "SELECT * FROM investments WHERE uid='$user_id'";
...
.form-container .btn:hover, .open-button:hover {
  opacity: 1;
    ...
    .scrollable-form {
  max-height: 500px; /* Set the maximum height to control the scrolling */
...
<body>
    ...
    <section class="section">
      ...
      while ($row = mysqli_fetch_assoc($result1)){?>
        <tr>
          ...
          <td>
            <button class="btn btn-primary" onclick="showEditForm(<?php echo $row['id']; ?>)">Edit</button>
          </td>
        </tr>
      <?php 
     $c=$c+1;
              ...
              <button class="btn btn-primary" type="button" id="" onclick="window.location.href = 'newinvestments.php';" >Add New Investment</button>
    </div>
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="">
      ...
      <label for="editName">New Type:</label>
      <br>
...
?>
      ...
      <br>
      <input type="number" class="form-control" name="editAmt" id="editAmt">
      <label for="editName">New Account:</label>
      <br>
      <?php
// Step 1: Database configuration
$host = "localhost";
...
mysqli_close($connection);
?>
  <label for="editName">New Number of Shares:</label>
      <br>
      <input type="number" class="form-control" name="editnum" id="editAmt">
      <label for="editName">New Current Price:</label>
      <br>
      <input type="number" class="form-control" name="editprice" id="editAmt">
      <label for="editName">New Price Date:</label>
      <br>
      <input type="date" class="form-control" name="editdate" id="editAmt">
<br>
      <button class="btn btn-primary" type="submit" name="editSubmit">Update</button>
      <br>
      <br>
      <button class="btn btn-primary" type="submit" name="editclose">Close Account</button>
      <br>
      <br>
