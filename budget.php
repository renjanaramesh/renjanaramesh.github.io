...
if (isset($_POST['editSubmit'])) {
  ...
  $sql = "UPDATE budget SET category='$editName',amount='$editAmt' WHERE id='$editId' and uid='$user_id'";
...
if (isset($_POST['editDelete'])) {
  ...
  // Update the row in the database
  $sql = "DELETE FROM budget WHERE id='$editId' and uid='$user_id'";
  if (mysqli_query($conn, $sql)) {
    echo "Record updated successfully.";
  } else {
    echo "Error updating record: " . mysqli_error($conn);
...
$sql = "SELECT * FROM budget WHERE uid='$user_id'";
...
<body>
  ...
  <div class="pagetitle">
    ...
    <section class="section">
     ...
     $c=$c+1;
              ...
              <button class="btn btn-primary" type="button" id="" onclick="window.location.href = 'newbudget.php';" >Add New Budget</button>
    </div>
  ...
  <div id="editForm" class="edit-form">
    ...
    <form method="POST" action="">
      ...
      <label for="editName">New Budget:</label>
      <br>
