            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create an Income</h5>
...
$query = "SELECT * FROM categories WHERE user_id='$user_id' and type='income'";
...
?>
                    ...
                    <div class="col-12">
                      <p class="small mb-0"><a href="income.php">Go Back</a></p>
                    </div>
                  </form>
  ...
  $conn = mysqli_connect('localhost', 'root', '', 'expense');
                 ...
                 $sql = "INSERT INTO income(category,amount,account_type,uid) VALUES ('$cat','$amt','$cat1','$user_id')";
