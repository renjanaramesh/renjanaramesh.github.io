...
$sql = "SELECT * FROM expenses WHERE uid='$user_id'";
  ...
  <div class="pagetitle">
    ...
    <section class="section">
     ...
     $c=$c+1;
              ...
              <button class="btn btn-primary" type="button" id="" onclick="window.location.href = 'newexpense.php';" >Add New Expense</button>
    </div>
